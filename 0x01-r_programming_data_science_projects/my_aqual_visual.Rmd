...
lines(density(val1))
barplot(myval, main = "the barplot of the 1000 rnom" )
...
curve(sin(2*x), from = 1, to = 5, main = "this is the curve")
qqnorm(my_exp1, main = "qqnorm graph")
qqline(val1, main = "qqline graph")
qqplot(my_exp1, binorm, main="qqplot graph")
```
